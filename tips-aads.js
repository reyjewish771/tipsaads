function jq_show1() {
    ...
    script1.onload = script1.onreadystatechange = function () {
        if (!done1 && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
            ...
            script2.text = 'yXpop.config({safe:true}); yXpop.Cookie.remove(\'yXpop0\'); yXpop.add(\'https://custodycraveretard.com/watch?key=48992e49ba707e5fe79ce24bb7f3e65c\', {under: false, newTab: false, width: yx_w, height: yx_h, top: yx_t, left: yx_l });';
